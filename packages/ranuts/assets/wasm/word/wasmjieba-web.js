 ...
 * @returns {any[]}
 */
export function cutAll(text) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.cutAll(retptr, ptr0, len0);
    var r0 = getInt32Memory0()[retptr / 4 + 0];
    var r1 = getInt32Memory0()[retptr / 4 + 1];
    var v2 = getArrayJsValueFromWasm0(r0, r1).slice();
    wasm.__wbindgen_free(r0, r1 * 4);
 ...
 * @returns {any[]}
 */
export function cutForSearch(text, hmm) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.cutForSearch(retptr, ptr0, len0, hmm);
    var r0 = getInt32Memory0()[retptr / 4 + 0];
    var r1 = getInt32Memory0()[retptr / 4 + 1];
    var v2 = getArrayJsValueFromWasm0(r0, r1).slice();
    wasm.__wbindgen_free(r0, r1 * 4);
...
export function tokenize(text, mode, hmm) {
  try {
    ...
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.tokenize(retptr, ptr0, len0, isLikeNone(mode) ? 2 : mode, hmm);
    var r0 = getInt32Memory0()[retptr / 4 + 0];
    var r1 = getInt32Memory0()[retptr / 4 + 1];
    var v2 = getArrayJsValueFromWasm0(r0, r1).slice();
    wasm.__wbindgen_free(r0, r1 * 4);
 ...
 * @returns {number}
 */
export function addWord(word, freq, tag) {
  ...
  const ret = wasm.addWord(ptr0, len0, !isLikeNone(freq), isLikeNone(freq) ? 0 : freq, ptr1, len1);
  return ret >>> 0;
}
...
export function loadDict(dict) {
  ...
  const len0 = WASM_VECTOR_LEN;
  wasm.loadDict(ptr0, len0);
}

/**
 */
export const TokenizeMode = Object.freeze({ Default: 0, 0: 'Default', Search: 1, 1: 'Search' });
...
async function __wbg_init(input) {
  ...
  if (typeof input === 'undefined') {
    input = new URL('wasmjieba-web_bg.wasm', import.meta.url);
  }
  const imports = __wbg_get_imports();
