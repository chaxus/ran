...
export type { ConversationNodeView } from '@/components/conversation';
export { Reasoning } from '@/components/reasoning';
export { TokenMeter } from '@/components/token-meter';
export type { TokenMeterLevel } from '@/components/token-meter';
export { StateDot } from '@/components/state-dot';
export type { StateDotState } from '@/components/state-dot';
export { DISCLOSURE_TOGGLE, DisclosureRow } from '@/components/disclosure-row';
export { OLDER_REQUEST } from '@/components/conversation';
export { ToolCard } from '@/components/tool-card';
export { Attachments } from '@/components/attachments';
export type { Attachment, AttachmentRejection } from '@/components/attachments';
export { VoiceButton } from '@/components/voice-button';
export type { ToolCallView, ToolCardStatus, ToolDiff, ToolLocation, ToolResultView } from '@/components/tool-card';
...
import type { Mermaid as TMermaid } from '@/components/mermaid';
import type { Markdown as TMarkdown } from '@/components/markdown';
...
import type { Conversation as TConversation } from '@/components/conversation';
import type { Reasoning as TReasoning } from '@/components/reasoning';
import type { TokenMeter as TTokenMeter } from '@/components/token-meter';
import type { StateDot as TStateDot } from '@/components/state-dot';
import type { DisclosureRow as TDisclosureRow } from '@/components/disclosure-row';
import type { ToolCard as TToolCard } from '@/components/tool-card';
import type { Attachments as TAttachments } from '@/components/attachments';
import type { VoiceButton as TVoiceButton } from '@/components/voice-button';
import type { Glass as TGlass } from '@/components/glass';
...
declare global {
  interface HTMLElementTagNameMap {
    ...
    'r-math': TMath;
    'r-mermaid': TMermaid;
    'r-markdown': TMarkdown;
    'r-popover': TPopover;
    'r-dropdown': TDropdown;
    'r-card': TCard;
    'r-conversation': TConversation;
    'r-reasoning': TReasoning;
    'r-token-meter': TTokenMeter;
    'r-state-dot': TStateDot;
    'r-disclosure-row': TDisclosureRow;
    'r-tool-card': TToolCard;
    'r-attachments': TAttachments;
    'r-voice-button': TVoiceButton;
    'r-glass': TGlass;
    'r-section': TSection;
    'r-router': TRouter;
    'r-route': TRoute;
