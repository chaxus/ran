...
const messages: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'nav.style': 'Style API',
    // hero
    'hero.eyebrow': 'Web Components · Zero deps',
    'hero.h1': 'Build native UI,<br>then <em>bend its skin.</em>',
    'hero.copy': 'Type-safe custom elements with no framework lock-in. One attribute to swap the entire visual skin.',
    'hero.cta.primary': 'Get started',
    'hero.cta.secondary': 'See theme packs →',
    ...
    'feature.cross.desc':
      'Use the same components from plain HTML, React, Vue, Svelte, or any runtime that renders DOM.',
    'feature.native.title': 'Native custom elements',
    'feature.native.desc':
      'Components ship as standards-based elements with encapsulated behavior and predictable markup.',
    ...
    'section.themes.subtitle':
      'Click any card to apply that theme pack. Toggle dark mode with the moon icon in the top-right.',
  ...
  zh: {
    ...
    'nav.style': '样式 API',
    // hero
    'hero.eyebrow': 'Web Components · 零依赖',
    'hero.h1': '构建原生 UI，<br>然后<em>随心换肤。</em>',
    'hero.copy': '类型安全的自定义元素，无框架绑定。一个属性即可切换整套视觉皮肤。',
    'hero.cta.primary': '快速开始',
    'hero.cta.secondary': '查看主题包 →',
    ...
    'section.themes.subtitle': '点击任意卡片即可切换主题包，右上角月亮图标可切换深色/浅色模式。',
