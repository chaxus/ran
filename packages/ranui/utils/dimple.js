...
dimple.chart = function (svg, data) {
    ...
    this._getData = function (data, cats, agg, order, stacked, x, y, z, p, c) {
        ...
        for (key in totals.x) { if (Object.prototype.hasOwnProperty.call(totals.x,key)) { grandTotals.x += totals.x[key]; } }
        for (key in totals.y) { if (Object.prototype.hasOwnProperty.call(totals.y,key)) { grandTotals.y += totals.y[key]; } }
        for (key in totals.p) { if (Object.prototype.hasOwnProperty.call(totals.p,key)) { grandTotals.p += totals.p[key]; } }
        for (key in totals.z) { if (Object.prototype.hasOwnProperty.call(totals.z,key)) { grandTotals.z += totals.z[key]; } }
