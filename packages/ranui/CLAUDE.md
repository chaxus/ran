...
│   ├── floating.ts       # FloatingController — the open/close state machine, portalling, positioning,
│   │                     # anchor-following and enter/exit animation behind r-select and r-popover
