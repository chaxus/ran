...
- `--ran-color-text-secondary` *(semantic)*
- `--ran-disclosure-chevron-size` *(internal)*
...
- `--ran-disclosure-sweep-color` *(internal)*
- `--ran-disclosure-sweep-duration` *(internal)*
- `--ran-disclosure-sweep-width` *(internal)*
- `--ran-disclosure-title-weight` *(internal)*
- `--ran-disclosure-toggle-duration` *(internal)*
...
#### Tokens
<!-- layers: semantic: 2 · internal: 9 -->
- `--ran-color-border` *(semantic)*
- `--ran-color-text-secondary` *(semantic)*
- `--ran-reasoning-body-indent` *(internal)*
...
#### Tokens
<!-- layers: semantic: 6 · component: 6 · internal: 14 -->
- `--ran-color-bg-muted` *(semantic)*
- `--ran-color-danger` *(semantic)*
- `--ran-color-primary` *(semantic)*
- `--ran-color-text-secondary` *(semantic)*
...
#### Tokens
<!-- layers: semantic: 10 · internal: 42 -->
- `--ran-color-bg-muted` *(semantic)*
- `--ran-color-border` *(semantic)*
- `--ran-color-danger` *(semantic)*
- `--ran-color-link` *(semantic)*
