...
Generated at: 2026-08-09T04:02:53.168Z
...
#### Tokens
<!-- layers: semantic: 13 · skin: 3 · component: 64 · internal: 9 -->
...
#### Tokens
<!-- layers: semantic: 12 · skin: 2 · component: 127 · internal: 13 -->
- `--ran-color-bg-elevated` *(semantic)*
- `--ran-color-bg-muted` *(semantic)*
- `--ran-color-border` *(semantic)*
- `--ran-color-border-hover` *(semantic)*
...
- `--ran-input-label-reserved-space` *(component)*
...
#### Tokens
<!-- layers: semantic: 5 · skin: 1 · component: 73 · internal: 5 -->
- `--ran-color-bg-elevated` *(semantic)*
- `--ran-color-text` *(semantic)*
...
#### Tokens
<!-- layers: semantic: 3 · component: 322 · internal: 16 -->
- `--ran-color-primary` *(semantic)*
- `--ran-dropdown-background` *(component)*
- `--ran-dropdown-box-shadow` *(component)*
...
#### Tokens
<!-- layers: semantic: 6 · skin: 1 · component: 124 · internal: 7 -->
- `--ran-color-bg-elevated` *(semantic)*
- `--ran-color-border` *(semantic)*
- `--ran-color-primary` *(semantic)*
- `--ran-color-text` *(semantic)*
