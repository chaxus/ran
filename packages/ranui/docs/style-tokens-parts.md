...
#### Tokens
<!-- layers: semantic: 9 · internal: 26 -->
- `--ran-attachment-background` *(internal)*
- `--ran-attachment-border-color` *(internal)*
- `--ran-attachment-border-radius` *(internal)*
- `--ran-attachment-focus-color` *(internal)*
- `--ran-attachment-gap` *(internal)*
- `--ran-attachment-icon-color` *(internal)*
- `--ran-attachment-max-width` *(internal)*
- `--ran-attachment-name-color` *(internal)*
- `--ran-attachment-name-font-size` *(internal)*
- `--ran-attachment-padding` *(internal)*
- `--ran-attachment-remove-color` *(internal)*
- `--ran-attachment-remove-hover-background` *(internal)*
- `--ran-attachment-remove-hover-color` *(internal)*
- `--ran-attachment-remove-radius` *(internal)*
- `--ran-attachment-remove-size` *(internal)*
- `--ran-attachment-size-color` *(internal)*
- `--ran-attachment-size-font-size` *(internal)*
- `--ran-attachment-thumb-radius` *(internal)*
- `--ran-attachment-thumb-size` *(internal)*
- `--ran-attachments-gap` *(internal)*
- `--ran-attachments-padding` *(internal)*
- `--ran-color-bg-hover` *(semantic)*
- `--ran-color-bg-subtle` *(semantic)*
...
#### Tokens
<!-- layers: semantic: 14 · skin: 3 · component: 68 · internal: 9 -->
...
#### Tokens
<!-- layers: semantic: 5 · component: 14 · internal: 6 -->
- `--ran-color-bg-elevated` *(semantic)*
- `--ran-color-border` *(semantic)*
- `--ran-color-border-hover` *(semantic)*
...
- `--ran-colorpicker-host-display` *(component)*
...
- `--ran-color-text` *(semantic)*
- `--ran-color-text-secondary` *(semantic)*
- `--ran-conversation-background` *(internal)*
- `--ran-conversation-color` *(internal)*
- `--ran-conversation-empty-color` *(internal)*
- `--ran-conversation-empty-padding` *(internal)*
- `--ran-conversation-focus-color` *(internal)*
- `--ran-conversation-font-size` *(internal)*
- `--ran-conversation-footer-background` *(internal)*
- `--ran-conversation-gap` *(internal)*
- `--ran-conversation-measure` *(internal)*
- `--ran-conversation-older-border-color` *(internal)*
- `--ran-conversation-older-color` *(internal)*
- `--ran-conversation-older-font-size` *(internal)*
- `--ran-conversation-older-hover-border-color` *(internal)*
- `--ran-conversation-older-hover-color` *(internal)*
- `--ran-conversation-older-padding` *(internal)*
- `--ran-conversation-older-radius` *(internal)*
- `--ran-conversation-padding` *(internal)*
- `--ran-radius-full` *(semantic)*
- `--ran-space-1` *(internal)*
...
#### Tokens
<!-- layers: semantic: 7 · internal: 16 -->
- `--ran-color-bg-hover` *(semantic)*
- `--ran-color-error` *(semantic)*
- `--ran-color-primary` *(semantic)*
- `--ran-color-text` *(semantic)*
- `--ran-color-text-disabled` *(semantic)*
- `--ran-color-text-secondary` *(semantic)*
- `--ran-disclosure-color` *(internal)*
- `--ran-disclosure-error-color` *(internal)*
- `--ran-disclosure-focus-color` *(internal)*
- `--ran-disclosure-font-size` *(internal)*
- `--ran-disclosure-gap` *(internal)*
- `--ran-disclosure-hover-background` *(internal)*
- `--ran-disclosure-leading-color` *(internal)*
- `--ran-disclosure-leading-size` *(internal)*
- `--ran-disclosure-radius` *(internal)*
- `--ran-disclosure-row-height` *(internal)*
- `--ran-disclosure-sep-color` *(internal)*
- `--ran-disclosure-summary-color` *(internal)*
- `--ran-disclosure-title-weight` *(internal)*
- `--ran-disclosure-transition` *(internal)*
- `--ran-radius-sm` *(semantic)*
- `--ran-space-2` *(internal)*
- `--ran-text-copy-2` *(internal)*
...
#### Tokens
<!-- layers: semantic: 6 · skin: 1 · component: 47 · internal: 5 -->
- `--ran-color-bg-elevated` *(semantic)*
- `--ran-color-border` *(semantic)*
- `--ran-color-text` *(semantic)*
- `--ran-dropdown-animation-duration` *(component)*
...
#### Tokens
<!-- layers: semantic: 13 · skin: 2 · internal: 77 -->
- `--ran-color-bg-muted` *(semantic)*
- `--ran-color-border` *(semantic)*
...
- `--ran-color-text-secondary` *(semantic)*
- `--ran-focus-ring` *(internal)*
- `--ran-font-family` *(semantic)*
- `--ran-font-mono` *(semantic)*
- `--ran-gray-alpha-200` *(internal)*
- `--ran-gray-alpha-500` *(internal)*
- `--ran-markdown-blockquote-border` *(internal)*
- `--ran-markdown-blockquote-border-width` *(internal)*
- `--ran-markdown-blockquote-color` *(internal)*
- `--ran-markdown-button-color` *(internal)*
- `--ran-markdown-button-hover-background` *(internal)*
- `--ran-markdown-button-hover-color` *(internal)*
- `--ran-markdown-button-size` *(internal)*
- `--ran-markdown-caret` *(internal)*
- `--ran-markdown-caret-color` *(internal)*
- `--ran-markdown-code-bg` *(internal)*
- `--ran-markdown-code-border` *(internal)*
- `--ran-markdown-code-color` *(internal)*
- `--ran-markdown-code-font-size` *(internal)*
- `--ran-markdown-code-header-bg` *(internal)*
- `--ran-markdown-code-header-height` *(internal)*
- `--ran-markdown-code-lang-color` *(internal)*
- `--ran-markdown-code-line-height` *(internal)*
- `--ran-markdown-code-padding` *(internal)*
- `--ran-markdown-code-radius` *(internal)*
- `--ran-markdown-color` *(internal)*
- `--ran-markdown-display` *(internal)*
- `--ran-markdown-error-background` *(internal)*
- `--ran-markdown-error-color` *(internal)*
- `--ran-markdown-error-padding` *(internal)*
- `--ran-markdown-font-family` *(internal)*
- `--ran-markdown-font-size` *(internal)*
- `--ran-markdown-gap` *(internal)*
- `--ran-markdown-h1-size` *(internal)*
- `--ran-markdown-h2-size` *(internal)*
- `--ran-markdown-h3-size` *(internal)*
- `--ran-markdown-h4-size` *(internal)*
- `--ran-markdown-heading-color` *(internal)*
- `--ran-markdown-heading-margin` *(internal)*
- `--ran-markdown-heading-weight` *(internal)*
- `--ran-markdown-hr-color` *(internal)*
- `--ran-markdown-image-radius` *(internal)*
- `--ran-markdown-inline-code-bg` *(internal)*
- `--ran-markdown-inline-code-color` *(internal)*
- `--ran-markdown-line-height` *(internal)*
- `--ran-markdown-line-number-color` *(internal)*
- `--ran-markdown-line-number-width` *(internal)*
- `--ran-markdown-link-color` *(internal)*
- `--ran-markdown-link-underline` *(internal)*
- `--ran-markdown-list-indent` *(internal)*
- `--ran-markdown-list-item-margin` *(internal)*
- `--ran-markdown-mono-font` *(internal)*
- `--ran-markdown-paragraph-margin` *(internal)*
- `--ran-markdown-strong-weight` *(internal)*
- `--ran-markdown-table-border` *(internal)*
- `--ran-markdown-table-cell-padding` *(internal)*
- `--ran-markdown-table-font-size` *(internal)*
- `--ran-markdown-table-header-bg` *(internal)*
- `--ran-markdown-table-header-color` *(internal)*
- `--ran-markdown-table-radius` *(internal)*
- `--ran-markdown-width` *(internal)*
- `--ran-radius-md` *(semantic)*
- `--ran-radius-sm` *(semantic)*
- `--ran-red-100` *(internal)*
- `--ran-size-4` *(internal)*
- `--ran-size-7` *(internal)*
- `--ran-skin-border-style` *(skin)*
- `--ran-skin-border-width` *(skin)*
...
- `--ran-space-3` *(internal)*
- `--ran-space-4` *(internal)*
- `--ran-space-5` *(internal)*
- `--ran-space-6` *(internal)*
- `--ran-text-copy-1` *(internal)*
- `--ran-text-copy-2` *(internal)*
- `--ran-text-heading-1` *(internal)*
- `--ran-text-heading-2` *(internal)*
- `--ran-text-heading-3` *(internal)*
- `--ran-text-heading-4` *(internal)*
- `--ran-text-heading-weight` *(internal)*
...
#### Tokens
<!-- layers: semantic: 5 · component: 359 · internal: 13 -->
- `--ran-color-` *(semantic)*
- `--ran-color-border` *(semantic)*
- `--ran-color-primary` *(semantic)*
- `--ran-dropdown-background` *(component)*
...
- `--ran-player-gesture-flash-center` *(component)*
...
#### Tokens
<!-- layers: semantic: 4 · internal: 16 -->
- `--ran-color-border` *(semantic)*
- `--ran-color-primary` *(semantic)*
- `--ran-color-text-disabled` *(semantic)*
- `--ran-color-text-secondary` *(semantic)*
- `--ran-reasoning-body-padding` *(internal)*
- `--ran-reasoning-border-color` *(internal)*
- `--ran-reasoning-color` *(internal)*
- `--ran-reasoning-focus-color` *(internal)*
- `--ran-reasoning-font-size` *(internal)*
- `--ran-reasoning-label-weight` *(internal)*
- `--ran-reasoning-marker-color` *(internal)*
- `--ran-reasoning-meta-color` *(internal)*
- `--ran-reasoning-padding-left` *(internal)*
- `--ran-reasoning-summary-gap` *(internal)*
- `--ran-reasoning-summary-padding` *(internal)*
- `--ran-space-1` *(internal)*
- `--ran-space-2` *(internal)*
- `--ran-space-3` *(internal)*
- `--ran-text-copy-2` *(internal)*
...
- `--ran-color-text-disabled` *(semantic)*
- `--ran-color-warning` *(semantic)*
- `--ran-state-dot-color` *(internal)*
- `--ran-state-dot-error-color` *(internal)*
- `--ran-state-dot-halo-opacity` *(internal)*
- `--ran-state-dot-running-color` *(internal)*
- `--ran-state-dot-size` *(internal)*
- `--ran-state-dot-success-color` *(internal)*
- `--ran-state-dot-warning-color` *(internal)*
...
- `--ran-space-2` *(internal)*
- `--ran-text-copy-3` *(internal)*
- `--ran-token-meter-color` *(internal)*
- `--ran-token-meter-fill-background` *(internal)*
- `--ran-token-meter-font-size` *(internal)*
- `--ran-token-meter-gap` *(internal)*
- `--ran-token-meter-over-background` *(internal)*
- `--ran-token-meter-track-background` *(internal)*
- `--ran-token-meter-track-height` *(internal)*
- `--ran-token-meter-track-radius` *(internal)*
- `--ran-token-meter-track-width` *(internal)*
- `--ran-token-meter-transition` *(internal)*
- `--ran-token-meter-warn-background` *(internal)*
...
#### Tokens
<!-- layers: semantic: 11 · internal: 43 -->
- `--ran-color-bg` *(semantic)*
- `--ran-color-bg-muted` *(semantic)*
- `--ran-color-border` *(semantic)*
- `--ran-color-error` *(semantic)*
...
- `--ran-color-text-secondary` *(semantic)*
- `--ran-font-mono` *(semantic)*
- `--ran-green-200` *(internal)*
- `--ran-radius-md` *(semantic)*
- `--ran-radius-sm` *(semantic)*
- `--ran-red-200` *(internal)*
- `--ran-size-4` *(internal)*
- `--ran-space-1` *(internal)*
- `--ran-space-2` *(internal)*
- `--ran-space-3` *(internal)*
...
- `--ran-text-copy-3` *(internal)*
- `--ran-text-mono-weight-regular` *(internal)*
- `--ran-tool-card-added-background` *(internal)*
- `--ran-tool-card-body-gap` *(internal)*
- `--ran-tool-card-body-padding` *(internal)*
- `--ran-tool-card-color` *(internal)*
- `--ran-tool-card-file-gap` *(internal)*
- `--ran-tool-card-font-size` *(internal)*
- `--ran-tool-card-gutter-color` *(internal)*
- `--ran-tool-card-gutter-width` *(internal)*
- `--ran-tool-card-hunk-gap` *(internal)*
- `--ran-tool-card-io-background` *(internal)*
- `--ran-tool-card-io-border-color` *(internal)*
- `--ran-tool-card-io-error-color` *(internal)*
- `--ran-tool-card-io-gutter-gap` *(internal)*
- `--ran-tool-card-io-label-color` *(internal)*
- `--ran-tool-card-io-label-size` *(internal)*
- `--ran-tool-card-io-max-height` *(internal)*
- `--ran-tool-card-io-padding` *(internal)*
- `--ran-tool-card-io-radius` *(internal)*
- `--ran-tool-card-line-gap` *(internal)*
- `--ran-tool-card-line-padding` *(internal)*
- `--ran-tool-card-location-color` *(internal)*
- `--ran-tool-card-locations-gap` *(internal)*
- `--ran-tool-card-locations-margin` *(internal)*
- `--ran-tool-card-output-background` *(internal)*
- `--ran-tool-card-output-font` *(internal)*
- `--ran-tool-card-output-max-height` *(internal)*
- `--ran-tool-card-output-padding` *(internal)*
- `--ran-tool-card-output-radius` *(internal)*
- `--ran-tool-card-output-weight` *(internal)*
- `--ran-tool-card-path-color` *(internal)*
- `--ran-tool-card-path-gap` *(internal)*
- `--ran-tool-card-removed-background` *(internal)*
- `--ran-tool-card-sweep-color` *(internal)*
...
#### Tokens
<!-- layers: semantic: 12 · internal: 26 -->
- `--ran-color-bg` *(semantic)*
- `--ran-color-bg-elevated` *(semantic)*
- `--ran-color-bg-subtle` *(semantic)*
- `--ran-color-border` *(semantic)*
...
- `--ran-space-3` *(internal)*
- `--ran-text-label-3` *(internal)*
- `--ran-voice-active-background` *(internal)*
- `--ran-voice-active-border-color` *(internal)*
- `--ran-voice-active-color` *(internal)*
- `--ran-voice-background` *(internal)*
- `--ran-voice-border-color` *(internal)*
- `--ran-voice-border-radius` *(internal)*
- `--ran-voice-cancel-background` *(internal)*
- `--ran-voice-color` *(internal)*
- `--ran-voice-disabled-color` *(internal)*
- `--ran-voice-focus-color` *(internal)*
- `--ran-voice-hint-background` *(internal)*
- `--ran-voice-hint-cancel-color` *(internal)*
- `--ran-voice-hint-color` *(internal)*
- `--ran-voice-hint-font-size` *(internal)*
- `--ran-voice-hint-gap` *(internal)*
- `--ran-voice-hint-padding` *(internal)*
- `--ran-voice-hint-radius` *(internal)*
- `--ran-voice-hint-shadow` *(internal)*
- `--ran-voice-hover-border-color` *(internal)*
- `--ran-voice-hover-color` *(internal)*
- `--ran-voice-size` *(internal)*
