...
#### Tokens
<!-- layers: semantic: 15 · internal: 52 -->
- `--ran-color-bg` *(semantic)*
- `--ran-color-bg-muted` *(semantic)*
- `--ran-color-bg-subtle` *(semantic)*
- `--ran-color-border` *(semantic)*
...
- `--ran-tool-card-background` *(internal)*
- `--ran-tool-card-body-border-color` *(internal)*
- `--ran-tool-card-body-padding` *(internal)*
- `--ran-tool-card-border-color` *(internal)*
- `--ran-tool-card-border-radius` *(internal)*
- `--ran-tool-card-color` *(internal)*
- `--ran-tool-card-description-color` *(internal)*
- `--ran-tool-card-description-gap` *(internal)*
- `--ran-tool-card-error-border-color` *(internal)*
- `--ran-tool-card-file-gap` *(internal)*
- `--ran-tool-card-focus-color` *(internal)*
- `--ran-tool-card-font-size` *(internal)*
- `--ran-tool-card-gutter-color` *(internal)*
- `--ran-tool-card-gutter-width` *(internal)*
- `--ran-tool-card-header-background` *(internal)*
- `--ran-tool-card-header-gap` *(internal)*
- `--ran-tool-card-header-padding` *(internal)*
- `--ran-tool-card-hunk-gap` *(internal)*
- `--ran-tool-card-input-gap` *(internal)*
- `--ran-tool-card-input-key-color` *(internal)*
...
- `--ran-tool-card-status-color` *(internal)*
- `--ran-tool-card-status-error-color` *(internal)*
- `--ran-tool-card-status-radius` *(internal)*
- `--ran-tool-card-status-size` *(internal)*
- `--ran-tool-card-status-success-color` *(internal)*
- `--ran-tool-card-title-weight` *(internal)*
- `--ran-tool-card-toggle-color` *(internal)*
