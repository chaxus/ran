...
Generated at: 2026-08-08T10:58:45.065Z
...
- `--ran-player-fullscreen-background` *(component)*
- `--ran-player-fullscreen-background-size` *(component)*
...
- `--ran-player-toggle-pause-background` *(component)*
- `--ran-player-toggle-pause-background-size` *(component)*
- `--ran-player-toggle-play-background` *(component)*
- `--ran-player-toggle-play-background-size` *(component)*
...
- `--ran-player-volume-icon-background` *(component)*
- `--ran-player-volume-icon-background-size` *(component)*
- `--ran-player-volume-icon-height` *(component)*
- `--ran-player-volume-icon-muted-background` *(component)*
- `--ran-player-volume-icon-muted-background-size` *(component)*
