...
Generated at: 2026-07-19T09:04:29.432Z
...
- **Attributes**: `copy`, `display: string`, `font: string`, `latex: string`, `macros: Record<string, string> | undefined`, `sheet: string`, `wrap: 'none' | 'tex' | '=' | undefined`
- **Properties**: `copyable: boolean`, `display: string`, `font: string`, `latex: string`, `macros: Record<string, string> | undefined`, `sheet: string`, `wrap: 'none' | 'tex' | '=' | undefined`
- **Events**: —
- **Slots**: —
- **Parts**: `button`, `error`, `math`, `render`, `toolbar`
