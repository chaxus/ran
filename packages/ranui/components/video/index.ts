import { SyncHook, addClassToElement, createDocumentFragment, range, removeClassToElement, throttle, timeFormat } from 'ranuts'
...
function Custom() {
  if (typeof document !== 'undefined' && !customElements.get('r-player')) {
    ...
    class RanPlayer extends HTMLElement {
      ...
      private _playerControllerBottomTime: HTMLDivElement;
      ...
      private _playControllerBottomSpeedProgress: HTMLElement;
      ...
      private clarityList?: { definition: string; label: string; value: string; url: string }[];
      ...
      constructor() {
        ...
        this._playerControllerBottomTime = document.createElement('div');
        this._playerControllerBottomTime.setAttribute('class', 'ran-player-controller-bottom-left-time');
        ...
        this._playControllerBottomSpeedPopover = document.createElement('ran-popover');
        ...
        this._playControllerBottomSpeedProgress = document.createElement('r-progress');
        ...
        this._playerControllerBottomLeft.appendChild(
          createDocumentFragment([
            ...
            this._playerControllerBottomTime,
        ...
        this._playControllerBottomVolume.appendChild(
          createDocumentFragment([this._playControllerBottomSpeedIcon, this._playControllerBottomSpeedProgress])!,
        );
      ...
      private changeAttribute = (k: string, o: string, n: string, attribute: string, callback: Function) => {
      ...
      private changeSpeedProgress = (e: CustomEvent): void => {
        if (this._video) {
      ...
      private changePlayerVolume = (): void => {
        ...
        if (volume > 0) {
          ...
          removeClassToElement(this._playControllerBottomSpeedIcon, 'ran-player-controller-bottom-right-volume-icon-volume');
          ...
          this._playControllerBottomSpeedProgress.setAttribute('percent', `${this._volume || 0.5}`);
          this.setVolume(0.5)
      ...
      connectedCallback(): void {
        ...
        // this._playControllerBottomSpeedProgress.addEventListener('change', this.changeSpeedProgress);
      ...
      disconnectCallback(): void {
        ...
        // this._playControllerBottomSpeedProgress.removeEventListener('change', this.changeSpeedProgress);
