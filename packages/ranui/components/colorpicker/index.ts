...
export class ColorPicker extends HTMLElementSSR()! {
  ...
  changeColorPalettePositionByContext = (): void => {
    window.requestAnimationFrame(() => {
      ...
      if (!this.context?.lightness.getter || !this.context?.saturation.getter)
        return;
      const { width, height } =
        this.colorPickerPanelPalette?.getBoundingClientRect() || {};
      const limitY = height - (this.context.lightness.getter() / 100) * height;
      const limitX = (this.context.saturation.getter() / 100) * width;
      this.colorPickerPanelDot?.style.setProperty(
        "top",
        `${limitY - BOT_WIDTH}px`
      );
      this.colorPickerPanelDot?.style.setProperty(
  ...
  changeColorPalettePosition = (offsetX: number, offsetY: number): void => {
    ...
    window.requestAnimationFrame(() => {
      this.colorPickerPanelDot?.style.setProperty(
        "top",
        `${offsetY - BOT_WIDTH}px`
      );
      this.colorPickerPanelDot?.style.setProperty(
        "left",
        `${offsetX - BOT_WIDTH}px`
      );
    });
  };
  ...
  createColorPickerProgress = (): void => {
    ...
    this.colorPickerPanelSliderContainer.setAttribute(
      "class",
      "ran-color-picker-slider-container"
    );
    this.colorPickerPanelSliderGroup = document.createElement("div");
    this.colorPickerPanelSliderGroup.setAttribute(
      "class",
      "ran-color-picker-slider-container-group"
    );
    ...
    this.colorPickerPanelSliderHue.setAttribute(
      "percent",
      `${this.context.hue.getter() / 360}`
    );
    this.colorPickerPanelSliderHue.addEventListener(
      "change",
      this.changeColorPickerHue
    );
    this.colorPickerPanelSliderHue.setAttribute("type", "drag");
    this.colorPickerPanelSliderHue.setAttribute(
      "class",
      "ran-color-picker-slider-container-group-hue"
    );
    this.colorPickerPanelSliderAlpha = document.createElement("r-progress");
    this.updateColorPickerPanelSliderAlphaProgressDot();
    this.colorPickerPanelSliderAlpha.setAttribute(
      "percent",
      `${this.context.transparency.getter() / 100}`
    );
    this.updateColorPickerPanelSliderAlphaProgressWrap();
    this.colorPickerPanelSliderAlpha.addEventListener(
      "change",
      this.changeColorPickerAlpha
    );
    this.colorPickerPanelSliderAlpha.setAttribute("type", "drag");
    this.colorPickerPanelSliderAlpha.setAttribute(
      "class",
      "ran-color-picker-slider-container-group-alpha"
    );
    this.colorPickerPanelSliderGroup.appendChild(
      this.colorPickerPanelSliderHue
    );
    this.colorPickerPanelSliderGroup.appendChild(
      this.colorPickerPanelSliderAlpha
    );
    this.colorPickerPanelSliderContainer.appendChild(
      this.colorPickerPanelSliderGroup
    );
    this.colorPickerColorBlock = document.createElement("div");
    this.colorPickerColorBlock.setAttribute(
      "class",
      "ran-color-picker-slider-container-color-block"
    );
    this.colorPickerColorBlockInner = document.createElement("div");
    this.colorPickerColorBlockInner.setAttribute(
      "class",
      "ran-color-picker-slider-container-color-block-inner"
    );
    this.updateColorPickerColorBlockInnerBackground();
    this.colorPickerColorBlock.appendChild(this.colorPickerColorBlockInner);
    this.colorPickerPanelSliderContainer.appendChild(
      this.colorPickerColorBlock
    );
  };
  ...
  createColorPickerSelect = (): void => {
    ...
    this.colorPickerInnerContentSelect.setAttribute(
      "class",
      "ran-color-picker-select"
    );
    ...
    this.colorPickerPanelPalette.setAttribute(
      "class",
      "ran-color-picker-palette"
    );
    this.colorPickerInnerContentSelect.appendChild(
      this.colorPickerPanelPalette
    );
    this.colorPickerPanelSaturation = document.createElement("div");
    this.colorPickerPanelSaturation.setAttribute(
      "class",
      "ran-color-picker-saturation"
    );
    this.updateColorPickerPanelSaturationBackground();
    this.colorPickerPanelDot = document.createElement("div");
    this.colorPickerPanelDotInner = document.createElement("div");
    this.colorPickerPanelDotInner.setAttribute(
      "class",
      "ran-color-picker-palette-dot-inner"
    );
    this.colorPickerPanelDot.setAttribute(
      "class",
      "ran-color-picker-palette-dot"
    );
    this.colorPickerPanelDot.addEventListener(
      "mousedown",
      this.mouseDownColorPickerPalette
    );
    document.body.addEventListener(
      "mousemove",
      this.mouseMoveColorPickerPalette
    );
    this.colorPickerPanelDot.addEventListener(
      "mouseup",
      this.mouseUpColorPickerPalette
    );
    ...
    this.colorPickerPanelPalette.addEventListener(
      "mousedown",
      this.clickColorPalette
    );
  };
  createColorPickerInput = (): void => {
    this.colorPickerInputContainer = document.createElement("div");
    this.colorPickerInputContainer.setAttribute(
      "class",
      "ran-color-picker-input-container"
    );
    const colorPickerInputContainerId = `${performance.now()}`.replace(".", "");
    // select
    this.colorPickerInputContainerSelect = document.createElement("div");
    this.colorPickerInputContainerSelect.setAttribute(
      "class",
      "ran-color-picker-input-container-select"
    );
    this.colorPickerInputContainerSelect.setAttribute(
      "id",
      colorPickerInputContainerId
    );
    this.colorPickerInputContainerSelectItem = document.createElement(
      "r-select"
    );
    this.colorPickerInputContainerSelectItem.setAttribute("value", "HEX");
    this.colorPickerInputContainerSelectItem.setAttribute(
      "class",
      "ran-color-picker-input-container-select-item"
    );
    this.colorPickerInputContainerSelectItem.setAttribute(
      "getPopupContainerId",
      colorPickerInputContainerId
    ...
    this.colorPickerInputContainerSelect.appendChild(
      this.colorPickerInputContainerSelectItem
    );
    this.colorPickerInputContainer.appendChild(
      this.colorPickerInputContainerSelect
    );
    this.colorPickerInputContainerInputColor = document.createElement(
      "r-input"
    );
    this.colorPickerInputContainerInputColor.setAttribute(
      "class",
      "ran-color-picker-input-container-input-color"
    );
    this.colorPickerInputContainerInputNumber = document.createElement(
      "r-input"
    );
    this.colorPickerInputContainerInputNumber.setAttribute(
      "class",
      "ran-color-picker-input-container-input-number"
    );
    this.colorPickerInputContainer.appendChild(
  ...
  openColorPicker = (): void => {
    ...
    this.colorPickerInnerContent.setAttribute(
      "class",
      "ran-color-picker-inner-content"
    );
    ...
    this.colorPickerPanelSliderContainer &&
      this.colorPickerInnerContent.appendChild(
        this.colorPickerPanelSliderContainer
      );
    this.colorPickerInputContainer &&
  ...
  mouseMoveColorPickerPalette = (e: MouseEvent): void => {
    ...
    const { pageX, pageY } = e;
    const { top = 0, left = 0, width, height } =
      this.colorPickerPanelPalette?.getBoundingClientRect() || {};
    const limitY = range(
      pageY - top - BOT_WIDTH,
      -BOT_WIDTH,
  ...
  disconnectCallback(): void {
    ...
    this.colorPickerPanelDot?.removeEventListener(
      "mousedown",
      this.mouseDownColorPickerPalette
    );
    ...
    this.colorPickerPanelPalette?.removeEventListener(
      "mousedown",
      this.clickColorPalette
    );
  }
