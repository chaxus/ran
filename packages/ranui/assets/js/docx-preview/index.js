/**
 * @description: https://github.com/VolodymyrBaydalka/docxjs
 * Error when evaluating SSR module, so copy to fix
 */
...
(function (RelationshipTypes) {
  ...
  RelationshipTypes['CustomProperties'] =
...
function mergeDeep(target, ...sources) {
  ...
  if (isObject(target) && isObject(source)) {
    for (const key in source) {
      // Add protection against prototype pollution
  ...
  renderSections(document) {
    ...
    for (let i = 0, l = sections.length; i < l; i++) {
      ...
      this.options.renderHeaders &&
        this.renderHeaderFooter(props.headerRefs, props, result.length, prevProps != props, sectionElement);
      ...
      this.options.renderFooters &&
        this.renderHeaderFooter(props.footerRefs, props, result.length, prevProps != props, sectionElement);
