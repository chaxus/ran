  ...
  return (function () {
      ...
      reportNonstrict(e, t, r) {
        ...
        if (('function' == typeof o && (o = o(e, t, r)), o && 'ignore' !== o)) {
          ...
          'warn' === o
            ...
            : 'undefined' != typeof console &&
              console.warn(
                "LaTeX-incompatible input and strict mode is set to unrecognized '" + o + "': " + t + ' [' + e + ']',
              );
        }
      }
    ...
    class Z {
      ...
      toNode() {
        ...
        for (const e in this.style)
          this.style.hasOwnProperty(e) && ((t = t || document.createElement('span')), (t.style[e] = this.style[e]));
    ...
    je({
      ...
      htmlBuilder(e, t) {
        ...
        return (
          n.classes.push('cd-label-' + e.side), (n.style.bottom = F(0.8 - n.depth)), (n.height = 0), (n.depth = 0), n
        );
      },
      mathmlBuilder(e, t) {
    ...
    je({
      ...
      je({
        ...
        mathmlBuilder(e, t) {
          ...
          return (
            e.newLine && (r.setAttribute('linebreak', 'newline'), e.size && r.setAttribute('height', F(P(e.size, t)))),
            r
          );
        },
      });
    ...
    je({
      ...
      handler(e) {
        ...
        if (_t[o.text])
          return (
            ('\\global' !== r && '\\\\globallong' !== r) || (o.text = _t[o.text]), qt(t.parseFunction(), 'internal')
          );
                        ...
                        : '[' === e || '\\lbrack' === e
                          ...
                          : ']' === e || '\\rbrack' === e
                            ? ((i = '\u23a4'),
                              ...
                              (p = 667))
                            : '\\lfloor' === e || '\u230a' === e
                              ? ((h = i = '\u23a2'), (c = '\u23a3'), (u = 'Size4-Regular'), (m = 'lfloor'), (p = 667))
                              : '\\lceil' === e || '\u2308' === e
                                ? ((i = '\u23a1'), (h = c = '\u23a2'), (u = 'Size4-Regular'), (m = 'lceil'), (p = 667))
                                : '\\rfloor' === e || '\u230b' === e
                                  ? ((h = i = '\u23a5'),
                                    (c = '\u23a6'),
                                    (u = 'Size4-Regular'),
    ...
    function vr(e, t) {
      ...
      throw new n(
        r ? "Invalid delimiter '" + r.text + "' after '" + t.funcName + "'" : "Invalid delimiter type '" + e.type + "'",
        e,
      );
    }
    function kr(e) {
    ...
    je({
      ...
      je({
        ...
        mathmlBuilder: (e, t) => {
          ...
          return (
            n.setAttribute('fence', 'true'), n.setAttribute('lspace', '0.05em'), n.setAttribute('rspace', '0.05em'), n
          );
        },
      });
    const Sr = (e, t) => {
        ...
        if ('sout' === n)
          ...
          /box/.test(n)
            ...
            /fbox|boxed|fcolorbox/.test(n)
              ...
              : 'angl' === n && 0.049 !== h && ((o.style.borderTopWidth = F(h)), (o.style.borderRightWidth = F(h))),
            (i = r.depth + l),
            e.backgroundColor &&
              ((o.style.backgroundColor = e.backgroundColor), e.borderColor && (o.style.borderColor = e.borderColor));
        }
        var h;
        let c;
    ...
    const Er = function (e, t) {
        ...
        for (o = 0, A = 0; o < a || A < S.length; ++o, ++A) {
          ...
          for (; 'separator' === c.type; ) {
            if (
              (p ||
                ((z = Ve.makeSpan(['arraycolsep'], [])), (z.style.width = F(t.fontMetrics().doubleRuleSep)), M.push(z)),
        ...
        if (e.cols && e.cols.length > 0) {
          ...
          for (let e = o; e < i; e++)
            'align' === t[e].type
              ...
              : 'separator' === t[e].type && n && ((r += '|' === t[e].separator ? 'solid ' : 'dashed '), (n = !1));
            ...
            (function (e) {
              ...
              return (
                ...
                e.gullet.endGroup(),
                {
                  ...
                  addJot: !0,
                  rowGaps: [null],
                  cols: new Array(o[0].length).fill({ type: 'align', align: 'c', pregap: 0.25, postgap: 0.25 }),
    ...
    je({
      ...
      je({
        ...
        handler(e, t) {
          ...
          return { type: 'infix', mode: r.mode, replaceWith: '\\\\abovefrac', size: qt(t[0], 'size').value, token: o };
        },
      }),
      je({
        type: 'genfrac',
    ...
    je({
      ...
      je({
        ...
        htmlBuilder(e, t) {
          const r = ht(e.body, t),
            n = P(e.dy, t);
          return Ve.makeVList({ positionType: 'shift', positionData: -n, children: [{ type: 'elem', elem: r }] }, t);
        },
        mathmlBuilder(e, t) {
          const r = new gt.MathNode('mpadded', [vt(e.body, t)]),
      ...
      je({
        ...
        mathmlBuilder(e, t) {
          ...
          return (
            o >= 0 ? a.setAttribute('height', F(o)) : (a.setAttribute('height', F(o)), a.setAttribute('depth', F(-o))),
        ...
        htmlBuilder(e, t) {
          ...
          if (e.index) {
            const r = t.havingStyle(w.SCRIPTSCRIPT),
              ...
              s = Ve.makeVList({ positionType: 'shift', positionData: -o, children: [{ type: 'elem', elem: n }] }, t),
    ...
    $e({
      ...
      htmlBuilder(e, t) {
        ...
        if (h) {
          const t =
            e.base && 'op' === e.base.type && e.base.name && ('\\oiint' === e.base.name || '\\oiiint' === e.base.name);
    ...
    je({
      ...
      je({
        ...
        htmlBuilder(e, t) {
          ...
          return Ve.makeVList({ positionType: 'shift', positionData: o, children: [{ type: 'elem', elem: r }] }, t);
        },
        mathmlBuilder(e, t) {
    ...
    Br(
      ...
      Br('\\Coloneqq', '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}=}}{\\mathop{\\char"2237\\char"3d}}'),
      Br(
        '\\coloneq',
      ...
      Br('\\Eqqcolon', '\\html@mathml{\\mathrel{=\\mathrel{\\mkern-1.2mu}\\dblcolon}}{\\mathop{\\char"3d\\char"2237}}'),
      Br(
        '\\eqcolon',
    ...
    class Vn {
      ...
      handleInfixNodes(e) {
        ...
        if (-1 !== r && t) {
          ...
          return (
            ...
            (o = 1 === i.length && 'ordgroup' === i[0].type ? i[0] : { type: 'ordgroup', mode: this.mode, body: i }),
      ...
      parseGroup(e, t) {
        ...
        if ('{' === o || '\\begingroup' === o) {
          ...
          ((s = this.parseFunction(t, e) || this.parseSymbol()), null == s && '\\' === o[0] && !Rn.hasOwnProperty(o))
        ) {
      ...
      formLigatures(e) {
        ...
        for (let r = 0; r < t; ++r) {
          ...
          '-' === o &&
            '-' === e[r + 1].text &&
            (r + 1 < t && '-' === e[r + 2].text
              ? (e.splice(r, 3, { type: 'textord', mode: 'text', loc: Cr.range(n, e[r + 2]), text: '---' }), (t -= 2))
              : (e.splice(r, 2, { type: 'textord', mode: 'text', loc: Cr.range(n, e[r + 1]), text: '--' }), (t -= 1))),
            ("'" !== o && '`' !== o) ||
              e[r + 1].text !== o ||
              (e.splice(r, 2, { type: 'textord', mode: 'text', loc: Cr.range(n, e[r + 1]), text: o + o }), (t -= 1));
        }
      }
      parseSymbol() {
        const e = this.fetch();
        ...
        if ((this.consume(), r))
          for (let t = 0; t < r[0].length; t++) {
            ...
            o = { type: 'accent', mode: this.mode, loc: Cr.range(e), label: i, isStretchy: !1, isShifty: !0, base: o };
          }
        return o;
      }
    }
