...
| -------------------------- | --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `cloneDeep(value)`         | `structuredClone(value)`    | The value contains functions or anything `structuredClone` refuses: it throws a `DataCloneError`, while `cloneDeep` copies what it can and keeps the rest by reference. |
...
| To combine two objects               | `merge(a, b)`          | Shallow merge: `b`'s keys win, and `a` is mutated.    |
