...
also fires when the **theme** flips — every element fading at its own pace while the rest of
the page has already switched. Animate motion properties (`transform`, `opacity`, geometry)
