...
description: Todos os símbolos exportados pelo ranuts: 454 exportações em 8 pontos de entrada, com assinaturas e descrições.
---

# API do ranuts (gerada)
...
entrada importar, restrições de ambiente, convenções) leia antes [CLAUDE.md](https://github.com/chaxus/ran/blob/main/packages/ranuts/CLAUDE.md).
...
**454 exportações** em 8 pontos de entrada.

## Pontos de entrada

- [`ranuts/utils`](#ranuts-utils) — Utilitários para o navegador e de uso geral · _navegador + node_ · 339 exportações
- [`ranuts/sw`](#ranuts-sw) — Estratégias de cache do Service Worker e o protocolo de pré-cache · _apenas service worker_ · 9 exportações
- [`ranuts/node`](#ranuts-node) — Utilitários de servidor Node (fs / http / ws / middleware) · _apenas node_ · 26 exportações
- [`ranuts/visual`](#ranuts-visual) — Motor de renderização 2D (Canvas / WebGL / WebGPU) · _apenas navegador_ · 16 exportações
- [`ranuts/i18n`](#ranuts-i18n) — Motor de i18n independente de framework (também reexportado de ranuts/utils) · _navegador + node_ · 9 exportações
- [`ranuts/vnode`](#ranuts-vnode) — DOM virtual no estilo do Snabbdom · _navegador_ · 26 exportações
- [`ranuts/stream`](#ranuts-stream) — Análise de SSE, uma dobra de fluxo de modelo neutra quanto ao fornecedor, e o orçamento de tokens que decide quando um histórico deixa de caber · _navegador + node_ · 20 exportações
- [`ranuts/conversation`](#ranuts-conversation) — Projeta um log de eventos somente-anexação em nós de conversa renderizáveis · _navegador + node_ · 9 exportações

## `ranuts/utils`

Utilitários para o navegador e de uso geral · ambiente: **navegador + node** · código: `src/utils/index.ts`
...
Estratégias de cache do Service Worker e o protocolo de pré-cache · ambiente: **apenas service worker** · código: `src/sw/index.ts`
...
Utilitários de servidor Node (fs / http / ws / middleware) · ambiente: **apenas node** · código: `src/node/index.ts`
...
Motor de renderização 2D (Canvas / WebGL / WebGPU) · ambiente: **apenas navegador** · código: `src/utils/visual/index.ts`
...
Motor de i18n independente de framework (também reexportado de ranuts/utils) · ambiente: **navegador + node** · código: `src/utils/i18n.ts`
...
DOM virtual no estilo do Snabbdom · ambiente: **navegador** · código: `src/vnode/index.ts`
...
Análise de SSE, uma dobra de fluxo de modelo neutra quanto ao fornecedor, e o orçamento de tokens que decide quando um histórico deixa de caber · ambiente: **navegador + node** · código: `src/stream/index.ts`
...
Projeta um log de eventos somente-anexação em nós de conversa renderizáveis · ambiente: **navegador + node** · código: `src/conversation/index.ts`
