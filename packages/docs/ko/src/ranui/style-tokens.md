---
title: ranui 스타일 토큰
description: ranui 의 각 엘리먼트가 노출하는 CSS 커스텀 프로퍼티와 ::part() 이름. 모두 스타일시트에서 추출했습니다.
---
