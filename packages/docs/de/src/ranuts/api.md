...
Laufzeit-Einschränkungen, welche Konventionen) lies zuerst [CLAUDE.md](https://github.com/chaxus/ran/blob/main/packages/ranuts/CLAUDE.md).
...
**454 Exporte** über 8 Entry Points.

## Entry Points

- [`ranuts/utils`](#ranuts-utils) — Browser- und Allzweck-Utilities · _Browser + node_ · 339 Exporte
- [`ranuts/sw`](#ranuts-sw) — Caching-Strategien des Service Workers und das Precache-Protokoll · _nur Service Worker_ · 9 Exporte
- [`ranuts/node`](#ranuts-node) — Utilities für den Node-Server (fs / http / ws / Middleware) · _nur node_ · 26 Exporte
- [`ranuts/visual`](#ranuts-visual) — 2D-Rendering-Engine (Canvas / WebGL / WebGPU) · _nur Browser_ · 16 Exporte
- [`ranuts/i18n`](#ranuts-i18n) — Frameworkunabhängige i18n-Engine (auch aus ranuts/utils reexportiert) · _Browser + node_ · 9 Exporte
- [`ranuts/vnode`](#ranuts-vnode) — Virtuelles DOM im Stil von Snabbdom · _Browser_ · 26 Exporte
- [`ranuts/stream`](#ranuts-stream) — SSE-Parsing, ein anbieterneutrales Falten von Modell-Streams und das Token-Budget, das entscheidet, wann ein Verlauf nicht mehr passt · _Browser + node_ · 20 Exporte
- [`ranuts/conversation`](#ranuts-conversation) — Projiziert ein reines Anhänge-Ereignisprotokoll auf renderbare Konversationsknoten · _Browser + node_ · 9 Exporte

## `ranuts/utils`

Browser- und Allzweck-Utilities · Laufzeit: **Browser + node** · Quelltext: `src/utils/index.ts`
...
Caching-Strategien des Service Workers und das Precache-Protokoll · Laufzeit: **nur Service Worker** · Quelltext: `src/sw/index.ts`
...
Utilities für den Node-Server (fs / http / ws / Middleware) · Laufzeit: **nur node** · Quelltext: `src/node/index.ts`
...
2D-Rendering-Engine (Canvas / WebGL / WebGPU) · Laufzeit: **nur Browser** · Quelltext: `src/utils/visual/index.ts`
...
Frameworkunabhängige i18n-Engine (auch aus ranuts/utils reexportiert) · Laufzeit: **Browser + node** · Quelltext: `src/utils/i18n.ts`
...
Virtuelles DOM im Stil von Snabbdom · Laufzeit: **Browser** · Quelltext: `src/vnode/index.ts`
...
SSE-Parsing, ein anbieterneutrales Falten von Modell-Streams und das Token-Budget, das entscheidet, wann ein Verlauf nicht mehr passt · Laufzeit: **Browser + node** · Quelltext: `src/stream/index.ts`
...
Projiziert ein reines Anhänge-Ereignisprotokoll auf renderbare Konversationsknoten · Laufzeit: **Browser + node** · Quelltext: `src/conversation/index.ts`
