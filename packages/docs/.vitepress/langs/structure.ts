...
const articleSidebar: SidebarNode[] = [
  { items: [
      ...
      { kind: "full", key: "sorting_algorithm", link: "/src/article/sort/", collapsed: true, items: [
      ...
      { kind: "full", key: "article_math", collapsed: true, items: [
          { kind: "full", key: "linear_algebra", link: "/src/article/math/linear_algebra" }
        ] },
      { kind: "full", key: "notes", collapsed: true, items: [
...
export const SIDEBAR: Record<string, SidebarNode[]> = {
  "/src/ranuts/": [
    ...
    { kind: "full", key: "utility_functions", link: "/src/ranuts/utils/", collapsed: false, items: [
        { kind: "full", key: "functional_programming", collapsed: true, items: [
            ...
            { kind: "dash", key: "withtimeout_deferred", name: "withTimeout / deferred", link: "/src/ranuts/utils/with_timeout" },
            { kind: "dash", key: "noop", name: "noop", link: "/src/ranuts/utils/noop" },
            { kind: "dash", key: "compose", name: "compose", link: "/src/ranuts/utils/compose" }
          ] },
        { kind: "full", key: "string_processing", collapsed: true, items: [
            { kind: "dash", key: "md5", name: "md5", link: "/src/ranuts/utils/md5" },
            { kind: "dash", key: "randomstring_getrandomstring", name: "randomString / getRandomString", link: "/src/ranuts/utils/random_string" },
            ...
            { kind: "dash", key: "getmatchingsentences", name: "getMatchingSentences", link: "/src/ranuts/utils/get_matching_sentences" },
        ...
        { kind: "full", key: "object_processing", collapsed: true, items: [
        ...
        { kind: "full", key: "number_processing", collapsed: true, items: [
            { kind: "dash", key: "range_clamp_lerp_remap_smoothstep", name: "range / clamp / lerp / remap / smoothstep", link: "/src/ranuts/utils/range" },
            ...
            { kind: "dash", key: "transformnumber", name: "transformNumber", link: "/src/ranuts/utils/transform_number" },
            { kind: "dash", key: "addnumsym", name: "addNumSym", link: "/src/ranuts/utils/add_num_sym" },
            { kind: "dash", key: "parsechinesenumber", name: "parseChineseNumber", link: "/src/ranuts/utils/parse_number" }
          ] },
        { kind: "full", key: "color_processing", collapsed: true, items: [
            ...
            { kind: "dash", key: "hextoalpha_rgbatorgb", name: "hexToAlpha / rgbaToRgb", link: "/src/ranuts/utils/color" },
            { kind: "dash", key: "blendscreen_luma_cosinepalette", name: "blendScreen / luma / cosinePalette", link: "/src/ranuts/utils/color" }
          ] },
        { kind: "full", key: "time_processing", collapsed: true, items: [
            { kind: "dash", key: "formatduration_formatrelative", name: "formatDuration / formatRelative", link: "/src/ranuts/utils/time_format" },
            { kind: "dash", key: "parsevtttimestamp_parsevttcuetiming", name: "parseVttTimestamp / parseVttCueTiming", link: "/src/ranuts/utils/time_format" },
            { kind: "dash", key: "formatdate", name: "formatDate", link: "/src/ranuts/utils/timestamp_to_time" },
            { kind: "dash", key: "performancetime", name: "performanceTime", link: "/src/ranuts/utils/performance_time" }
          ] },
        { kind: "full", key: "device_detection", collapsed: true, items: [
            ...
            { kind: "dash", key: "watchmediaquery", name: "watchMediaQuery", link: "/src/ranuts/utils/watch_media_query" }
          ] },
        { kind: "full", key: "dom_manipulation", collapsed: true, items: [
            { kind: "dash", key: "addclasstoelement", name: "addClassToElement", link: "/src/ranuts/utils/add_class_to_element" },
            { kind: "dash", key: "removeclasstoelement", name: "removeClassToElement", link: "/src/ranuts/utils/remove_class_to_element" },
            { kind: "dash", key: "createdocumentfragment", name: "createDocumentFragment", link: "/src/ranuts/utils/create_document_fragment" },
            ...
            { kind: "dash", key: "eventmanager_createdoubletapdetector", name: "EventManager / createDoubleTapDetector", link: "/src/ranuts/utils/event_manager" },
            ...
            { kind: "dash", key: "setfontsize2html", name: "setFontSize2html", link: "/src/ranuts/utils/set_font_size" }
          ] },
        { kind: "full", key: "storage", collapsed: true, items: [
        ...
        { kind: "full", key: "url_query", collapsed: true, items: [
            { kind: "dash", key: "getallquerystring", name: "getAllQueryString", link: "/src/ranuts/utils/get_all_query_string" },
            { kind: "dash", key: "queryflag_isiniframe", name: "queryFlag / isInIframe", link: "/src/ranuts/utils/query_flag" },
        ...
        { kind: "full", key: "cookie", collapsed: true, items: [
            { kind: "dash", key: "getcookie", name: "getCookie", link: "/src/ranuts/utils/get_cookie" },
            { kind: "dash", key: "getcookiebyname", name: "getCookieByName", link: "/src/ranuts/utils/get_cookie_by_name" }
          ] },
        { kind: "full", key: "image_processing", collapsed: true, items: [
            { kind: "dash", key: "convertimagetobase64", name: "convertImageToBase64", link: "/src/ranuts/utils/convert_image_to_base64" },
            { kind: "dash", key: "isimagesize", name: "isImageSize", link: "/src/ranuts/utils/is_image_size" },
            { kind: "dash", key: "getimage_cutround_opacity", name: "getImage / cutRound / opacity", link: "/src/ranuts/utils/image_process" }
          ] },
        { kind: "full", key: "media", collapsed: true, items: [
            { kind: "dash", key: "audiorecorder", name: "AudioRecorder", link: "/src/ranuts/utils/audio_recorder" },
            { kind: "dash", key: "createspeechrecognizer", name: "createSpeechRecognizer", link: "/src/ranuts/utils/speech" }
          ] },
        { kind: "full", key: "performance", collapsed: true, items: [
        ...
        { kind: "full", key: "network", collapsed: true, items: [
        ...
        { kind: "full", key: "browser", collapsed: true, items: [
            ...
            { kind: "dash", key: "createobjecturl_requesturltobuffer", name: "createObjectURL / requestUrlToBuffer", link: "/src/ranuts/utils/create_object_url" }
          ] },
        { kind: "full", key: "script_loading", collapsed: true, items: [
        ...
        { kind: "full", key: "error_handling", collapsed: true, items: [
            { kind: "dash", key: "handleconsole_intercept", name: "handleConsole", link: "/src/ranuts/utils/handle_console" },
            { kind: "dash", key: "handleerror", name: "handleError", link: "/src/ranuts/utils/handle_error" },
            { kind: "dash", key: "handlefetchhook", name: "handleFetchHook", link: "/src/ranuts/utils/handle_fetch_hook" }
          ] },
        { kind: "full", key: "others", collapsed: true, items: [
            ...
            { kind: "dash", key: "durationhandler", name: "durationHandler", link: "/src/ranuts/utils/duration_handler" },
            { kind: "dash", key: "task", name: "task", link: "/src/ranuts/utils/task" }
          ] }
      ] },
    { kind: "full", key: "file_operations", collapsed: true, items: [
    ...
    { kind: "full", key: "mime_type", collapsed: true, items: [
        { kind: "dash", key: "getmime", name: "getMime", link: "/src/ranuts/mime_type/mime_type" }
      ] },
    { kind: "full", key: "canvas_animation", collapsed: true, items: [
    ...
    { kind: "full", key: "i18n", collapsed: true, items: [
        { kind: "full", key: "internationalisation_engine", link: "/src/ranuts/i18n/" }
      ] },
    { kind: "full", key: "2d_rendering_visual", collapsed: true, items: [
        { kind: "full", key: "rendering_engine", link: "/src/ranuts/visual/" }
      ] },
    { kind: "full", key: "virtual_dom_vnode", collapsed: true, items: [
        { kind: "full", key: "virtual_dom", link: "/src/ranuts/vnode/" }
      ] },
    { kind: "full", key: "streaming_stream", collapsed: true, items: [
        { kind: "full", key: "streaming_model_responses", link: "/src/ranuts/stream/" }
      ] },
    { kind: "full", key: "conversation_conversation", collapsed: true, items: [
        { kind: "full", key: "event_log_to_nodes", link: "/src/ranuts/conversation/" }
      ] },
    { kind: "full", key: "service_worker_sw", collapsed: true, items: [
        { kind: "full", key: "caching_precache", link: "/src/ranuts/sw/" }
      ] },
    { kind: "full", key: "node_server", collapsed: true, items: [
        { kind: "full", key: "http_server_router", link: "/src/ranuts/node/" }
      ] },
    { kind: "full", key: "bridge_postmessage", collapsed: true, items: [
        { kind: "full", key: "cross_context_messaging", link: "/src/ranuts/bridge/" }
      ] }
  ],
  "/src/ranui/": [
    ...
    { kind: "full", key: "foundations", items: [
    ...
    { kind: "full", key: "data_presentation", items: [
    ...
    { kind: "full", key: "data_entry", items: [
    ...
    { kind: "full", key: "navigation", items: [
