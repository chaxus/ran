...
۱. برای هرچه باید از پوسته پیروی کند **هیچ کد شانزده‌شانزدهی خامی ننویسید**.
۲. **مقدار جایگزین باید توکنی را نام ببرد که می‌چرخد**: `var(--ran-color-text, var(--ran-gray-1000))`، نه `var(--ran-color-text, #171717)`.
۳. **مقدار جایگزین باید توکنی موجود را نام ببرد**، وگرنه اعلان دور ریخته می‌شود و عنصر بی‌صدا همان چیزی را که به ارث برده نگه می‌دارد.
