---
title: تغییرات ranui
description: 'چه چیزی در ranui تغییر کرد — افزوده، تغییریافته، اصلاح‌شده و حذف‌شده به همراه دلیل آن، و یادداشت‌های فنی تاریخ‌دار پشت هر دسته تغییر.'
---
...
::: warning ranui در مرحلهٔ alpha است
...
انتشارها و برچسب‌ها در [GitHub](https://github.com/chaxus/ran/releases) و هر نسخهٔ منتشرشده در
[npm](https://www.npmjs.com/package/ranui?activeTab=versions) است.
