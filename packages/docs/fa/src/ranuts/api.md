...
description: همهٔ نمادهایی که ranuts صادر می‌کند — 454 خروجی در 8 نقطهٔ ورود، همراه با امضا و توضیح.
---

# API کتابخانهٔ ranuts (تولید خودکار)
...
نخست [CLAUDE.md](https://github.com/chaxus/ran/blob/main/packages/ranuts/CLAUDE.md) را بخوانید.
...
**454 خروجی** در 8 نقطهٔ ورود.

## نقاط ورود

- [`ranuts/utils`](#ranuts-utils) — ابزارهای مرورگر و ابزارهای عمومی · _مرورگر + node_ · 339 خروجی
- [`ranuts/sw`](#ranuts-sw) — راهبردهای حافظهٔ نهان Service Worker و پروتکل پیش‌بارگذاری · _فقط service worker_ · 9 خروجی
- [`ranuts/node`](#ranuts-node) — ابزارهای سرور Node (fs / http / ws / میان‌افزار) · _فقط node_ · 26 خروجی
- [`ranuts/visual`](#ranuts-visual) — موتور رندر دوبعدی (Canvas / WebGL / WebGPU) · _فقط مرورگر_ · 16 خروجی
- [`ranuts/i18n`](#ranuts-i18n) — موتور i18n مستقل از فریم‌ورک (از ranuts/utils هم دوباره صادر می‌شود) · _مرورگر + node_ · 9 خروجی
- [`ranuts/vnode`](#ranuts-vnode) — DOM مجازی به سبک Snabbdom · _مرورگر_ · 26 خروجی
- [`ranuts/stream`](#ranuts-stream) — تجزیهٔ SSE، تاکردن جریان پاسخ مدل به‌شکل مستقل از ارائه‌دهنده، و بودجهٔ توکن که تعیین می‌کند تاریخچه از چه نقطه‌ای دیگر جا نمی‌شود · _مرورگر + node_ · 20 خروجی
- [`ranuts/conversation`](#ranuts-conversation) — نگاشت گزارش رویداد فقط‌افزودنی به گره‌های گفت‌وگوی قابل رندر · _مرورگر + node_ · 9 خروجی

## `ranuts/utils`

ابزارهای مرورگر و ابزارهای عمومی · محیط اجرا: **مرورگر + node** · کد منبع: `src/utils/index.ts`
...
راهبردهای حافظهٔ نهان Service Worker و پروتکل پیش‌بارگذاری · محیط اجرا: **فقط service worker** · کد منبع: `src/sw/index.ts`
...
ابزارهای سرور Node (fs / http / ws / میان‌افزار) · محیط اجرا: **فقط node** · کد منبع: `src/node/index.ts`
...
موتور رندر دوبعدی (Canvas / WebGL / WebGPU) · محیط اجرا: **فقط مرورگر** · کد منبع: `src/utils/visual/index.ts`
...
موتور i18n مستقل از فریم‌ورک (از ranuts/utils هم دوباره صادر می‌شود) · محیط اجرا: **مرورگر + node** · کد منبع: `src/utils/i18n.ts`
...
DOM مجازی به سبک Snabbdom · محیط اجرا: **مرورگر** · کد منبع: `src/vnode/index.ts`
...
تجزیهٔ SSE، تاکردن جریان پاسخ مدل به‌شکل مستقل از ارائه‌دهنده، و بودجهٔ توکن که تعیین می‌کند تاریخچه از چه نقطه‌ای دیگر جا نمی‌شود · محیط اجرا: **مرورگر + node** · کد منبع: `src/stream/index.ts`
...
نگاشت گزارش رویداد فقط‌افزودنی به گره‌های گفت‌وگوی قابل رندر · محیط اجرا: **مرورگر + node** · کد منبع: `src/conversation/index.ts`
