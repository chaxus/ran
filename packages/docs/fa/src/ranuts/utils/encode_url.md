...
1. **کدگذاری هوشمند**: تنها بخش‌های کدگذاری‌نشده را دست می‌زند و دنباله‌های از پیش کدگذاری‌شده مانند `%20` را همان‌طور می‌گذارد.
2. **جفت‌های جانشین**: جفت‌های جانشین بی‌قرین خودبه‌خود رسیدگی و با نویسهٔ جایگزین یونیکد عوض می‌شوند.
3. **ایمنی**: خطایی پرتاب نمی‌کند و تا جای ممکن نشانی را درست کدگذاری می‌کند.
4. **کاربرد**: معمولاً برای نشانی‌هایی که کاربر وارد می‌کند و برای ساختن نشانی‌های امن به کار می‌رود.
