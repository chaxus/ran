...
1. **لرزش**: نوسان شبکه را نشان می‌دهد؛ اختلاف بیشترین و کمترین مقدار در چند سنجش، و هرچه کمتر، شبکه پایدارتر.
2. **شیوهٔ سنجش**: چند درخواست تصویر می‌فرستد و میانگین تأخیر و لرزش را حساب می‌کند.
3. **مقدارهای پیش‌فرض**: پنج سنجش با فاصلهٔ سه ثانیه.
4. **کاربرد**: معمولاً برای سنجش کیفیت شبکه، پایش کارایی و بهبود تجربهٔ کاربر به کار می‌رود.
