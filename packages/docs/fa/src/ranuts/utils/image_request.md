...
1. **نشانی پیش‌فرض**: اگر نشانی ندهید، favicon گیت‌هاب (حدود ۲٫۲ کیلوبایت) به کار می‌رود.
2. **روش سنجش**: زمان بارگذاری تصویر، از آغاز درخواست تا پایان بارگذاری، اندازه گرفته می‌شود.
3. **مدیریت خطا**: اگر تصویر بارگذاری نشود، Promise رد می‌شود.
4. **کاربرد**: معمولاً برای سنجش کیفیت شبکه و پایش کارایی به کار می‌رود.
