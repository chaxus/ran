...
2. **رسیدگی به دقت**: با `Mathjs` حساب می‌کند تا خطای اعشار شناور پیش نیاید.

3. **ورودی نامعتبر**: اگر ورودی عدد معتبری نباشد، `'--'` برمی‌گرداند.

4. **کاربرد**: معمولاً برای نمایش عددهای بزرگ مانند مبلغ، بازدید و شمار دنبال‌کنندگان به کار می‌رود.
