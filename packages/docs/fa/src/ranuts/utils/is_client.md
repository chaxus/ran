...
1. **شیوه تشخیص**: با `typeof window !== 'undefined'` تشخیص می‌دهد.
2. **یک ثابت است**: `isClient` تابع نیست بلکه ثابت است، پس هنگام استفاده پرانتز لازم ندارد.
3. **کجا به کار می‌آید**: برای جدا کردن محیط کلاینت از سرور و پرهیز از خطا هنگام استفاده از APIهای مرورگر در سرور رایج است.
