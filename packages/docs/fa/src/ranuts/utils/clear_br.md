...
۱. **چه چیزی پاک می‌شود**: همه فاصله‌ها، تگ‌های HTML و شکست خط‌ها (`\r\n`).
۲. **رشته خالی**: اگر ورودی رشته خالی باشد، همان رشته خالی برمی‌گردد.
۳. **کجا به کار می‌آید**: برای بیرون کشیدن متن خام و برداشتن نشانه‌های قالب‌بندی رایج است.
