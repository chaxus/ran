...
۱. **پروتکل**: اگر نشانی با `//` آغاز شود، `https://` پیش از آن گذاشته می‌شود.

۲. **ادغام پارامترها**: اگر نشانی از پیش پارامتر پرس‌وجو داشته باشد، پارامترهای تازه پس از آن‌ها می‌آیند.

۳. **کنار گذاشتن مقدار خالی**: پارامترهایی که مقدارشان رشتهٔ خالی است کنار می‌روند و به نشانی راه نمی‌یابند.

۴. **کدگذاری نشانی**: مقدار پارامترها خودبه‌خود برای نشانی کدگذاری می‌شود.

۵. **رونویسی**: اگر نام پارامتر از پیش باشد، مقدار تازه جای مقدار پیشین را می‌گیرد (رفتار `URLSearchParams` چنین است).
