...
1. **تشخیص خودکار**: تگ‌های SVG را خودش می‌شناسد و با فضای‌نام درست می‌سازد.
2. **عنصرهای HTML**: عنصرهای معمولی HTML با `document.createElement` ساخته می‌شوند.
3. **عنصرهای SVG**: عنصرهای SVG با `document.createElementNS` ساخته می‌شوند.
4. **کاربرد**: معمولاً جایی به کار می‌آید که باید عنصر SVG ساخته شود و مسیر کار را کوتاه می‌کند.
