...
1. **نویسه‌های گریزانده‌شده**: این نویسه‌ها عوض می‌شوند:
...
2. **تبدیل نوع**: هر چه رشته نباشد نخست به رشته تبدیل و سپس گریزانده می‌شود.

3. **امنیت**: برای جلوگیری از حملهٔ XSS است؛ هر جا محتوای ورودی کاربر را نشان می‌دهید از آن استفاده کنید.

4. **کارایی**: رشته‌ای که نویسهٔ ویژه ندارد، همان‌طور برگردانده می‌شود.
