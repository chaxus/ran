...
1. **کاملاً مستقل**: رونوشت هیچ چیزی با نسخهٔ اصلی شریک نیست؛ دگرگون کردن یکی به دیگری کاری ندارد.
2. **رونوشت ژرف**: همهٔ شیءها و آرایه‌های تودرتو را بازگشتی رونوشت می‌کند.
3. **ارجاع‌های چرخه‌ای**: درست رسیدگی می‌شوند.
4. **کارایی**: برای شیءها یا آرایه‌های بزرگ، رونوشت ژرف ممکن است کند باشد.
5. **توابع و شیءهای ویژه**: شیوهٔ رونوشت برخی شیءهای ویژه (مانند توابع و عبارت‌های باقاعده) بسته به پیاده‌سازی می‌تواند فرق کند.
