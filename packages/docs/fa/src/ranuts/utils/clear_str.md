...
۱. **چه چیزی برداشته می‌شود**: فاصله‌های دو سر و گیومه‌های تکی و دوتایی.
۲. **رمزگشایی نشانی**: به‌طور پیش‌فرض انجام می‌شود و با `urlencoded: false` می‌توان خاموشش کرد.
۳. **کاربرد**: معمولاً برای پاک کردن ورودی کاربر یا مقدارهایی که از پارامترهای نشانی بیرون کشیده شده‌اند به کار می‌رود.
