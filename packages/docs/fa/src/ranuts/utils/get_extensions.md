...
1. **شکل خروجی**: پسوندهای بازگشتی نقطه (`.`) ندارند؛ یعنی `'jpg'` نه `'.jpg'`.
2. **چند پسوند**: یک نوع MIME ممکن است به چند پسوند مربوط باشد و همهٔ موارد منطبق برگردانده می‌شوند.
3. **آرایهٔ خالی**: اگر آن نوع MIME وجود نداشته باشد، آرایهٔ خالی برمی‌گردد.
4. **کاربرد**: معمولاً برای بررسی نوع فایل، وارسی بارگذاری‌ها و مانند آن به کار می‌رود.
