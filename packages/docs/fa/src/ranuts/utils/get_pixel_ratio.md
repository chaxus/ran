...
1. **سازگاری با مرورگرها**: ویژگی `backingStorePixelRatio` را در مرورگرهای گوناگون در نظر می‌گیرد.
2. **پشتیبانی از تراکم بالا**: نمایشگرهای پرتراکم (Retina) را خودش می‌رساند تا ترسیم شفاف بماند.
3. **شیوهٔ محاسبه**: مقدار `devicePixelRatio / backingStorePixelRatio` را برمی‌گرداند.
4. **کاربرد**: معمولاً در ترسیم روی Canvas، کتابخانه‌های نمودار و ساخت بازی — هر جا شفافیت مهم است — به کار می‌رود.
