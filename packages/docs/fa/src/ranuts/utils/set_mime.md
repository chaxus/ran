...
1. **اثر سراسری**: آنچه تعیین می‌کنید بر کل نگاشت نوع‌های MIME اثر می‌گذارد و هر جا `getMime` به کار رفته باشد دگرگون می‌شود.
2. **رونویسی**: اگر آن پسوند از پیش باشد، نوع MIME پیشینش رونویسی می‌شود.
3. **مقدار بازگشتی**: کل Map نوع‌های MIME را برمی‌گرداند، پس می‌توانید کار را روی آن ادامه دهید.
4. **کاربرد**: معمولاً برای افزودن نوع MIME به گونه‌های سفارشی فایل به کار می‌رود.
