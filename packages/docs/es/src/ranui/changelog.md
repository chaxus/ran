...
Las publicaciones y etiquetas están en [GitHub](https://github.com/chaxus/ran/releases), y cada versión
publicada está en [npm](https://www.npmjs.com/package/ranui?activeTab=versions).
