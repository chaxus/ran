...
entrada importar, restricciones de ejecución, convenciones) lee antes [CLAUDE.md](https://github.com/chaxus/ran/blob/main/packages/ranuts/CLAUDE.md).
...
**454 exportaciones** en 8 puntos de entrada.

## Puntos de entrada

- [`ranuts/utils`](#ranuts-utils) — Utilidades para el navegador y de propósito general · _navegador + node_ · 339 exportaciones
- [`ranuts/sw`](#ranuts-sw) — Estrategias de caché del Service Worker y el protocolo de precarga · _solo service worker_ · 9 exportaciones
- [`ranuts/node`](#ranuts-node) — Utilidades de servidor Node (fs / http / ws / middleware) · _solo node_ · 26 exportaciones
- [`ranuts/visual`](#ranuts-visual) — Motor de renderizado 2D (Canvas / WebGL / WebGPU) · _solo navegador_ · 16 exportaciones
- [`ranuts/i18n`](#ranuts-i18n) — Motor de i18n independiente de framework (también reexportado desde ranuts/utils) · _navegador + node_ · 9 exportaciones
- [`ranuts/vnode`](#ranuts-vnode) — DOM virtual al estilo de Snabbdom · _navegador_ · 26 exportaciones
- [`ranuts/stream`](#ranuts-stream) — Análisis de SSE, un plegado de flujos de modelo neutral respecto al proveedor, y el presupuesto de tokens que decide cuándo un historial deja de caber · _navegador + node_ · 20 exportaciones
- [`ranuts/conversation`](#ranuts-conversation) — Proyecta un registro de eventos de solo anexado en nodos de conversación renderizables · _navegador + node_ · 9 exportaciones

## `ranuts/utils`

Utilidades para el navegador y de propósito general · entorno: **navegador + node** · código: `src/utils/index.ts`
...
Estrategias de caché del Service Worker y el protocolo de precarga · entorno: **solo service worker** · código: `src/sw/index.ts`
...
Utilidades de servidor Node (fs / http / ws / middleware) · entorno: **solo node** · código: `src/node/index.ts`
...
Motor de renderizado 2D (Canvas / WebGL / WebGPU) · entorno: **solo navegador** · código: `src/utils/visual/index.ts`
...
Motor de i18n independiente de framework (también reexportado desde ranuts/utils) · entorno: **navegador + node** · código: `src/utils/i18n.ts`
...
DOM virtual al estilo de Snabbdom · entorno: **navegador** · código: `src/vnode/index.ts`
...
Análisis de SSE, un plegado de flujos de modelo neutral respecto al proveedor, y el presupuesto de tokens que decide cuándo un historial deja de caber · entorno: **navegador + node** · código: `src/stream/index.ts`
...
Proyecta un registro de eventos de solo anexado en nodos de conversación renderizables · entorno: **navegador + node** · código: `src/conversation/index.ts`
