---
description: "23 种经典 GoF 设计模式导览——创建型、结构型与行为型，配前端示例。"
---
...
<!-- 本文中大部分是 UML 类图，也有个别简易流程图。由于文中部分模式并未配图，你可以在 [这里](../../../assets/article/designPattern/UML/creational/singleton.jpg) 查看我在网络上收集的完整 23 种设计模式 UML 类图。 -->
