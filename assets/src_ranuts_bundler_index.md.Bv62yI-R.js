import{_ as s}from"./chunks/bundle.BxrzsuA1.js";import{_ as a,c as e,o as p,al as t}from"./chunks/framework.BOE7hEeL.js";const m=JSON.parse('{"title":"Bundler","description":"","frontmatter":{},"headers":[],"relativePath":"src/ranuts/bundler/index.md","filePath":"src/ranuts/bundler/index.md","lastUpdated":1744899402000}'),l={name:"src/ranuts/bundler/index.md"};function r(i,n,d,o,c,u){return p(),e("div",null,n[0]||(n[0]=[t(`<h1 id="bundler" tabindex="-1">Bundler <a class="header-anchor" href="#bundler" aria-label="Permalink to &quot;Bundler&quot;">​</a></h1><p><code>Bundler</code>的使用： 传入 options 参数</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function build(options: Options):Promise&lt;Build&gt; {</span></span>
